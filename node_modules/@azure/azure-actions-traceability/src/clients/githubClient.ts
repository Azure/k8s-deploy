...
export class GitHubClient {
    ...
    public async getWorkflowRun(runId: string): Promise<any> {
        ...
        console.debug(`Getting workflow run for repo: ${this._repository} and runId: ${runId}`);
    ...
    public async getWorkflow(workflowId: string): Promise<any> {
        ...
        console.debug(`Getting workflow for repo: ${this._repository} and workflowId: ${workflowId}`);
