...
function getFilePathsConfigs() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let registryCredentialsMap = {};
        let pathKey, pathValue, registryName, username, password;
        ...
        let credentialList = (process.env.REGISTRY_CREDENTIALS && process.env.REGISTRY_CREDENTIALS.split('\n')) || [];
            ...
            try {
                if (registryCredentialsMap && registryCredentialsMap[containerRegistryName]) {
                    ...
                    if (registryPassword && registryUsername) {
                        let loginArgs = [containerRegistryName, '--username', registryUsername, '--password', registryPassword];
