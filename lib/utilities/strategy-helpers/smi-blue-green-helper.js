...
exports.cleanupSMI = exports.validateTrafficSplitsState = exports.routeBlueGreenSMI = exports.setupSMI = exports.rejectBlueGreenSMI = exports.promoteBlueGreenSMI = exports.deployBlueGreenSMI = void 0;
...
const canary_deployment_helper_1 = require("./canary-deployment-helper");
...
function deployBlueGreenSMI(kubectl, filePaths) {
    ...
    const manifestObjects = blue_green_helper_1.getManifestObjects(kubectl, filePaths);
...
function setupSMI(kubectl, serviceEntityList) {
    ...
    serviceEntityList.forEach((serviceObject) => {
        ...
        const newStableService = blue_green_helper_1.getAuxiliaryService(serviceObject, canary_deployment_helper_1.STABLE_LABEL_VALUE);
        const newGreenService = blue_green_helper_1.getAuxiliaryService(serviceObject, blue_green_helper_2.GREEN_LABEL_VALUE);
