...
function deployBlueGreenIngress(kubectl, filePaths) {
    ...
    manifestObjects.serviceEntityList.forEach(inputObject => {
        const newBlueGreenObject = blue_green_helper_1.getAuxiliaryService(inputObject, blue_green_helper_2.GREEN_LABEL_VALUE);
        ;
...
function rejectBlueGreenIngress(kubectl, filePaths) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        routeBlueGreenIngress(kubectl, blue_green_helper_2.NONE_LABEL_VALUE, manifestObjects.serviceNameMap, manifestObjects.ingressEntityList);
...
function validateIngressesState(kubectl, ingressEntityList, serviceNameMap) {
    ...
    ingressEntityList.forEach((inputObject) => {
        ...
        if (!!existingIngress) {
            if (!blue_green_helper_1.isGreenObject(existingIngress)) {
