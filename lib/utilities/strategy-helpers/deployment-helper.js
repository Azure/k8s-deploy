...
function annotateAndLabelResources(files, kubectl, resourceTypes, allPods, inputManifestFiles) {
    return __awaiter(this, void 0, void 0, function* () {
        const workflowFilePath = yield utility_1.getWorkflowFilePath(TaskInputParameters.githubToken);
        const buildConfigs = yield utility_1.getFilePathsConfigs(inputManifestFiles);
