...
exports.getParsedYaml = exports.getManifestFileContents = exports.writeManifestToFile = exports.writeObjectsToFile = exports.assertFileExists = exports.ensureDirExists = exports.getNewUserDirPath = exports.getTempDirectory = void 0;
const fs = require("fs");
...
function getManifestFileContents(filePath) {
    if (filePath &&
        filePath.length > 0) {
        try {
...
exports.getManifestFileContents = getManifestFileContents;
function getParsedYaml(filePath) {
    const rawContent = fs.readFileSync(filePath, { encoding: "utf-8" });
    return yaml.safeLoad(rawContent);
}
exports.getParsedYaml = getParsedYaml;
