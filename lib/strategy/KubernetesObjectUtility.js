...
function isDeploymentEntity(kind) {
    ...
    return kubernetesconstants_1.deploymentTypes.some((type) => {
        return StringComparison_1.isEqual(type, kind, StringComparison_1.StringComparer.OrdinalIgnoreCase);
    });
}
...
function isServiceEntity(kind) {
    ...
    return StringComparison_1.isEqual("Service", kind, StringComparison_1.StringComparer.OrdinalIgnoreCase);
}
...
function getReplicaCount(inputObject) {
    ...
    if (!StringComparison_1.isEqual(kind, kubernetesconstants_1.KubernetesWorkload.pod, StringComparison_1.StringComparer.OrdinalIgnoreCase) && !StringComparison_1.isEqual(kind, kubernetesconstants_1.KubernetesWorkload.daemonSet, StringComparison_1.StringComparer.OrdinalIgnoreCase)) {
...
function updateSelectorLabels(inputObject, newLabels, override) {
    ...
    if (StringComparison_1.isEqual(inputObject.kind, kubernetesconstants_1.KubernetesWorkload.pod, StringComparison_1.StringComparer.OrdinalIgnoreCase)) {
        return;
    }
...
function getResources(filePaths, filterResourceTypes) {
    ...
    filePaths.forEach((filePath) => {
        ...
        yaml.safeLoadAll(fileContents, function (inputObject) {
            ...
            if (filterResourceTypes.filter(type => StringComparison_1.isEqual(inputObjectKind, type, StringComparison_1.StringComparer.OrdinalIgnoreCase)).length > 0) {
                const resource = {
...
function getImagePullSecrets(inputObject) {
    ...
    if (StringComparison_1.isEqual(inputObject.kind, kubernetesconstants_1.KubernetesWorkload.cronjob, StringComparison_1.StringComparer.OrdinalIgnoreCase)) {
        try {
