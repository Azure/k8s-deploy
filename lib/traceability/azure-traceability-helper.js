...
function addTraceability(kubectl, deploymentConfig, status) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const deploymentReport = yield createDeploymentReport(kubectl, deploymentConfig, status);
...
function createDeploymentReport(kubectl, deploymentConfig, status) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield deploymentReport.initialize(InputParameters.githubToken, artifacts, status, resource);
