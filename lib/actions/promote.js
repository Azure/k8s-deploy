...
function promoteBlueGreen(kubectl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const manifestObjects = blue_green_helper_1.getManifestObjects(kubectl, inputManifestFiles);
        ...
        if (blue_green_helper_2.isIngressRoute()) {
            ingress_blue_green_helper_1.routeBlueGreenIngress(kubectl, blue_green_helper_2.NONE_LABEL_VALUE, manifestObjects.serviceNameMap, manifestObjects.ingressEntityList);
