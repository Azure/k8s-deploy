...
function promote() {
    return __awaiter(this, void 0, void 0, function* () {
        const kubectl = new kubectl_1.Kubectl(yield utils.getKubectl(), TaskInputParameters.namespace, true);
...
function promoteCanary(kubectl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (canaryDeploymentHelper.isSMICanaryStrategy()) {
            ...
            yield deploy.deploy(kubectl, TaskInputParameters.manifests, "None");
        ...
        try {
            ...
            core.warning("Exception occurred while deleting canary and baseline workloads. Exception: " +
                ex);
        }
    });
}
function promoteBlueGreen(kubectl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let inputManifestFiles = manifest_utilities_1.updateManifestFiles(TaskInputParameters.manifests);
        ...
        const resources = KubernetesObjectUtility.getResources(deployedManifestFiles, models.DEPLOYMENT_TYPES.concat([
