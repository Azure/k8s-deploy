...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let forceDeployment = core.getInput('force') === 'true';
        if (action === 'deploy') {
            let strategy = core.getInput('strategy');
            console.log("strategy: ", strategy);
            yield deployment_helper_1.deploy(new kubectl_object_model_1.Kubectl(kubectlPath, namespace, undefined, forceDeployment), manifests, strategy);
        }
